        ...
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests((auth)->
                        auth
                                ...
                                .requestMatchers(new AntPathRequestMatcher("/candidates")).permitAll()
                                .requestMatchers(new AntPathRequestMatcher("/candidates/{id}/vote")).hasRole("USER")
                                .requestMatchers(new AntPathRequestMatcher("/candidates/**")).hasRole("ADMIN")
